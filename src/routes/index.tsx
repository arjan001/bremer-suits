...
function HomePage() {
  ...
  // Portfolio items for the "Our Custom Work" section - show up to 4
  const workShowcase = portfolioItems.slice(0, 4)
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* ===== OUR CUSTOM WORK — Gallery Section (styled like "Read Our Latest News") ===== */}
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-sm text-gray-400 mt-3 italic" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>
          ...
          {workShowcase.length > 0 ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                {workShowcase.map((item) => (
                  ...
                  >
                    ...
                    <h3
                      className="text-base font-semibold text-black group-hover:text-gray-600 transition-colors leading-snug mb-2"
                      style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
                    >
                      {item.title}
                    </h3>
                    <p className="text-sm text-gray-400 italic" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>
                      {item.category || 'Tailors'}
                    </p>
                  </Link>
                ))}
              </div>
            ...
            /* Fallback: show static portfolio images if no API data */
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                {[
                  { image: '/images/portfolio/portfolio-1.webp', title: 'Bespoke Wedding Suit', category: 'Wedding Styling' },
                  { image: '/images/portfolio/portfolio-2.webp', title: 'Corporate Collection', category: 'Tailoring' },
                  { image: '/images/portfolio/portfolio-3.webp', title: 'Custom Evening Wear', category: 'Fashion Design' },
                  { image: '/images/portfolio/portfolio-4.webp', title: 'Personal Styling Session', category: 'Image Consulting' },
                ].map((item) => (
                  <Link
                    key={item.title}
                    to="/portfolio"
