  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-black overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-10 text-center">
          <p className="text-xs tracking-[0.4em] uppercase text-gold mb-2 font-medium">
            Get in Touch
          </p>
          <h1
