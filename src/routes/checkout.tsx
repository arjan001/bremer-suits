...
export const Route = createFileRoute('/checkout')({
  head: () => ({
    meta: [
      { title: 'Secure Checkout | Bremer Suits — Complete Your Order' },
      { name: 'description', content: 'Complete your Bremer Suits order securely. Safe payment processing via M-Pesa and card for premium custom suits and menswear delivered across Kenya.' },
      { name: 'keywords', content: 'Bremer Suits checkout, secure payment, buy suits online Kenya, M-Pesa payment suits, card payment menswear, order suits Nairobi, Bremer Suits order, online suit purchase Kenya, secure suit payment, menswear checkout' },
      ...
      { property: 'og:title', content: 'Secure Checkout | Bremer Suits' },
      { property: 'og:description', content: 'Complete your order securely with Bremer Suits. Premium custom suits and menswear.' },
      { property: 'og:type', content: 'website' },
      { property: 'og:url', content: 'https://bremersuits.com/checkout' },
      ...
      { property: 'og:image:alt', content: 'Bremer Suits - Secure Checkout' },
      { property: 'og:image:type', content: 'image/jpeg' },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:site', content: '@bremersuits' },
      { name: 'twitter:creator', content: '@bremersuits' },
      { name: 'twitter:title', content: 'Secure Checkout | Bremer Suits' },
      { name: 'twitter:description', content: 'Complete your order securely with Bremer Suits.' },
      { name: 'twitter:image', content: 'https://bremersuits.com/images/og-logo-gold-black.jpg' },
      { name: 'twitter:image:alt', content: 'Bremer Suits - Secure Checkout' },
    ...
    links: [
      { rel: 'canonical', href: 'https://bremersuits.com/checkout' },
    ],
  }),
  component: Checkout,
})
