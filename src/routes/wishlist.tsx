...
export const Route = createFileRoute('/wishlist')({
  head: () => ({
    meta: [
      { title: 'My Wishlist | Bremer Suits — Saved Favourites' },
      { name: 'description', content: 'View and manage your saved favourite suits, menswear, and accessories from Bremer Suits. Keep track of items you love for your next purchase.' },
      { name: 'keywords', content: 'Bremer Suits wishlist, saved suits, favourite menswear, suit bookmarks, Bremer Suits favourites, saved items, wishlist suits Kenya, menswear wishlist Nairobi, fashion favourites, saved products Bremer, suit collection wishlist' },
      ...
      { property: 'og:title', content: 'My Wishlist | Bremer Suits' },
      { property: 'og:description', content: 'Your saved favourite suits and menswear from Bremer Suits.' },
      { property: 'og:type', content: 'website' },
      { property: 'og:url', content: 'https://bremersuits.com/wishlist' },
      ...
      { property: 'og:image:alt', content: 'Bremer Suits - My Wishlist' },
      { property: 'og:image:type', content: 'image/jpeg' },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:site', content: '@bremersuits' },
      { name: 'twitter:creator', content: '@bremersuits' },
      { name: 'twitter:title', content: 'My Wishlist | Bremer Suits' },
      { name: 'twitter:description', content: 'Your saved favourite suits and menswear from Bremer Suits.' },
      { name: 'twitter:image', content: 'https://bremersuits.com/images/og-logo-gold-black.jpg' },
      { name: 'twitter:image:alt', content: 'Bremer Suits - My Wishlist' },
    ...
    links: [
      { rel: 'canonical', href: 'https://bremersuits.com/wishlist' },
    ],
  }),
