...
export const Route = createFileRoute('/terms-of-service')({
  head: () => ({
    meta: [
      { title: 'Terms of Service | Bremer Suits — Customer Agreement & Policies' },
      { name: 'description', content: 'Review the Bremer Suits terms of service for custom tailoring orders, private consultations, online purchases, and bespoke suit services in Nairobi, Kenya.' },
      { name: 'keywords', content: 'Bremer Suits terms of service, customer agreement, tailoring terms conditions, bespoke suit agreement, custom order terms Kenya, Nairobi tailor policies, online purchase terms, suit consultation agreement, refund terms, payment terms tailoring, Bremer Suits legal terms, Kenya business terms, custom clothing agreement, tailoring service contract, Bremer Suits policies' },
      ...
      { property: 'og:title', content: 'Terms of Service | Bremer Suits' },
      { property: 'og:description', content: 'Review the complete terms and conditions for Bremer Suits custom tailoring services, orders, and consultations.' },
      { property: 'og:type', content: 'website' },
      { property: 'og:url', content: 'https://bremersuits.com/terms-of-service' },
      ...
      { property: 'og:image:alt', content: 'Bremer Suits - Terms of Service' },
      { property: 'og:image:type', content: 'image/jpeg' },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:site', content: '@bremersuits' },
      { name: 'twitter:creator', content: '@bremersuits' },
      { name: 'twitter:title', content: 'Terms of Service | Bremer Suits' },
      { name: 'twitter:description', content: 'Review the complete terms and conditions for Bremer Suits custom tailoring services and orders.' },
      { name: 'twitter:image', content: 'https://bremersuits.com/images/og-logo-gold-black.jpg' },
      { name: 'twitter:image:alt', content: 'Bremer Suits - Terms of Service' },
    ...
    links: [
      { rel: 'canonical', href: 'https://bremersuits.com/terms-of-service' },
    ],
  }),
