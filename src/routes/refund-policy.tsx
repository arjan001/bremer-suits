...
export const Route = createFileRoute('/refund-policy')({
  head: () => ({
    meta: [
      { title: 'Refund & Return Policy | Bremer Suits — Exchange & Cancellation Terms' },
      { name: 'description', content: 'Understand the Bremer Suits refund, return, and exchange policy for custom-made orders, ready-to-wear purchases, and alterations. Clear guidelines for hassle-free returns in Nairobi, Kenya.' },
      { name: 'keywords', content: 'Bremer Suits refund policy, return policy Kenya, suit exchange policy, custom order refund, ready-to-wear returns, bespoke suit cancellation, tailoring refund terms, damaged suit replacement, Nairobi tailor returns, Bremer Suits exchange, suit alteration refund, menswear return policy, Kenya clothing returns, hassle-free refund, Bremer Suits customer service' },
      ...
      { property: 'og:title', content: 'Refund & Return Policy | Bremer Suits' },
      { property: 'og:description', content: 'Clear refund and return guidelines for Bremer Suits custom orders and ready-to-wear purchases. Hassle-free exchanges and customer support.' },
      { property: 'og:type', content: 'website' },
      { property: 'og:url', content: 'https://bremersuits.com/refund-policy' },
      ...
      { property: 'og:image:alt', content: 'Bremer Suits - Refund & Return Policy' },
      { property: 'og:image:type', content: 'image/jpeg' },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:site', content: '@bremersuits' },
      { name: 'twitter:creator', content: '@bremersuits' },
      { name: 'twitter:title', content: 'Refund & Return Policy | Bremer Suits' },
      { name: 'twitter:description', content: 'Clear refund and return guidelines for Bremer Suits custom orders and ready-to-wear purchases.' },
      { name: 'twitter:image', content: 'https://bremersuits.com/images/og-logo-gold-black.jpg' },
      { name: 'twitter:image:alt', content: 'Bremer Suits - Refund & Return Policy' },
    ...
    links: [
      { rel: 'canonical', href: 'https://bremersuits.com/refund-policy' },
    ],
  }),
