...
export const Route = createFileRoute('/collections/')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Browse our collection of premium custom suits, ready-to-wear menswear, and luxury accessories. Handcrafted quality from Bremer Suits, Nairobi\'s finest tailors.' },
      { name: 'keywords', content: 'Bremer Suits, Bremer, BremerSuits, BREMER SUITS, premium suits Nairobi, custom suits collection, men\'s wear Kenya, luxury suits online, Bremer Suits collection, ready-to-wear suits Nairobi, bremer suits shop, buy suits online Kenya, men\'s formal wear, designer suits Nairobi, wedding suits for sale, corporate suit collection, slim fit suits Kenya, classic suits menswear' },
      ...
      { property: 'og:title', content: 'Collections | Premium Suits & Menswear | Bremer Suits Nairobi' },
      { property: 'og:description', content: 'Browse our collection of premium custom suits, ready-to-wear menswear, and luxury accessories from Bremer Suits.' },
      { property: 'og:type', content: 'website' },
      { property: 'og:url', content: 'https://bremersuits.com/collections' },
      ...
      { property: 'og:image:alt', content: 'Bremer Suits Collections - Premium Suits & Menswear' },
      { property: 'og:image:type', content: 'image/jpeg' },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:site', content: '@bremersuits' },
      { name: 'twitter:creator', content: '@bremersuits' },
      { name: 'twitter:title', content: 'Collections | Premium Suits & Menswear | Bremer Suits' },
      { name: 'twitter:description', content: 'Premium custom suits, ready-to-wear menswear, and luxury accessories from Nairobi\'s finest tailors.' },
      { name: 'twitter:image', content: 'https://bremersuits.com/images/og-gold-striped-suit.jpg' },
      { name: 'twitter:image:alt', content: 'Bremer Suits Collections - Premium Suits & Menswear' },
      ...
      { name: 'subject', content: 'Premium Suits & Menswear Collection' },
    ...
    links: [
      { rel: 'canonical', href: 'https://bremersuits.com/collections' },
    ],
  }),
