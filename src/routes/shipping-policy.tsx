...
export const Route = createFileRoute('/shipping-policy')({
  head: () => ({
    meta: [
      { title: 'Shipping & Delivery Policy | Bremer Suits — Nationwide Delivery Kenya' },
      { name: 'description', content: 'Learn about Bremer Suits shipping and delivery options for custom suits and menswear across Nairobi and Kenya. Dispatch on Tuesdays and Fridays, in-store pickup available, and nationwide delivery.' },
      { name: 'keywords', content: 'Bremer Suits shipping policy, delivery options Kenya, suit delivery Nairobi, nationwide shipping Kenya, custom suit dispatch, menswear delivery times, in-store pickup Nairobi, Bremer Suits delivery, shipping costs Kenya, order tracking suits, Tuesday Friday dispatch, suit packaging delivery, Kenya courier services, Bremer Suits logistics, express suit delivery' },
      ...
      { property: 'og:title', content: 'Shipping & Delivery Policy | Bremer Suits' },
      { property: 'og:description', content: 'Bremer Suits delivers custom suits and menswear across Nairobi and Kenya. Dispatch on Tuesdays and Fridays with in-store pickup available.' },
      { property: 'og:type', content: 'website' },
      { property: 'og:url', content: 'https://bremersuits.com/shipping-policy' },
      ...
      { property: 'og:image:alt', content: 'Bremer Suits - Shipping & Delivery Policy' },
      { property: 'og:image:type', content: 'image/jpeg' },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:site', content: '@bremersuits' },
      { name: 'twitter:creator', content: '@bremersuits' },
      { name: 'twitter:title', content: 'Shipping & Delivery Policy | Bremer Suits' },
      { name: 'twitter:description', content: 'Bremer Suits delivers custom suits and menswear across Nairobi and Kenya with dispatch on Tuesdays and Fridays.' },
      { name: 'twitter:image', content: 'https://bremersuits.com/images/og-logo-gold-black.jpg' },
      { name: 'twitter:image:alt', content: 'Bremer Suits - Shipping & Delivery Policy' },
    ...
    links: [
      { rel: 'canonical', href: 'https://bremersuits.com/shipping-policy' },
    ],
  }),
