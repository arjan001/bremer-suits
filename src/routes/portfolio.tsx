...
export const Route = createFileRoute('/portfolio')({
  head: () => ({
    meta: [
      { title: 'Bespoke Gallery | Wedding Tuxedos & High-End Suit Portfolio | Bremer Suits' },
      { name: 'description', content: 'Browse the Bremer Suits gallery. View our custom-made wedding tuxedos, ruracio attire, senator suits, Kaunda suits, and sharp corporate wear designed for Nairobi\'s most influential men.' },
      { name: 'keywords', content: 'Bremer Suits, Bremer, BremerSuits, BREMER SUITS, wedding suit ideas Kenya, bespoke suit gallery, men\'s fashion portfolio Nairobi, custom tuxedo designs, Bremer Suits lookbook, bespoke tuxedos Nairobi, bremer suits portfolio, senator suit Kenya, Kaunda suit designs, groomsmen suits Nairobi, made-to-measure gallery, corporate suit lookbook, wedding attire Kenya, ruracio styling portfolio' },
      ...
      { property: 'og:title', content: 'Bespoke Gallery | Wedding Tuxedos & High-End Suit Portfolio | Bremer Suits' },
      { property: 'og:description', content: 'Browse the Bremer Suits gallery. View our custom-made wedding tuxedos, ruracio attire, and sharp corporate wear designed for Nairobi\'s most influential men.' },
      { property: 'og:type', content: 'website' },
      { property: 'og:url', content: 'https://bremersuits.com/portfolio' },
      { property: 'og:site_name', content: 'Bremer Suits' },
      { property: 'og:locale', content: 'en_KE' },
      { property: 'og:image', content: 'https://bremersuits.com/images/og-groomsmen-black-tux.jpg' },
      { property: 'og:image:width', content: '1200' },
      { property: 'og:image:height', content: '630' },
      { property: 'og:image:alt', content: 'Bremer Suits Portfolio - Black Tuxedo Groomsmen Collection' },
      { property: 'og:image:type', content: 'image/jpeg' },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:site', content: '@bremersuits' },
      { name: 'twitter:creator', content: '@bremersuits' },
      { name: 'twitter:title', content: 'Bespoke Gallery | Wedding Tuxedos & Suit Portfolio | Bremer Suits' },
      { name: 'twitter:description', content: 'Browse custom-made wedding tuxedos, ruracio attire, and corporate wear from Nairobi\'s finest tailors.' },
      { name: 'twitter:image', content: 'https://bremersuits.com/images/og-groomsmen-black-tux.jpg' },
      { name: 'twitter:image:alt', content: 'Bremer Suits Portfolio - Black Tuxedo Groomsmen Collection' },
      ...
      { name: 'subject', content: 'Bespoke Suit Gallery & Portfolio' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="columns-2 md:columns-3 lg:columns-4 gap-3 lg:gap-4 space-y-3 lg:space-y-4">
            {paginatedItems.map((item, idx) => (
              ...
              >
                <div className="relative overflow-hidden bg-gray-100" onClick={() => setSelectedImage(item.src)}>
                  <img
                    src={item.src}
